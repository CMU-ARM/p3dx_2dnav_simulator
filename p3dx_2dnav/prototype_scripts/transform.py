...
class Transform:
    def __init__(self):
        self.sub = rospy.Subscriber('/p3dx/base_pose_ground_truth', Odometry, self.handle_transform, queue_size=2)
        self.pub = rospy.Publisher('/tmp', Odometry, queue_size=1)
    ...
    def handle_transform(self, msg):
        ...
        t.sendTransform((msg.pose.pose.position.x, msg.pose.pose.position.y, 0),
